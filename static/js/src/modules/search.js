...
class SearchResultItem {
  constructor() {
    this.subheading = list(
      "div.result-subheading-container",
...
class SearchResultFilter {
  ...
  updateFilterSearch(index, status) {
    ...
    this.activefilter = this.categories
      .filter((k, i) => {
...
class SearchResult {
  constructor() {
    ...
    this.resultFilters = new SearchResultFilter(
      this.projects,
...
class ProjectRecommendations {
  constructor() {
    ...
    this.projectLinks = el(
      "div.recommended-navs",
      this.link1,
      this.link2,
      this.link3,
      this.link4,
...
class SearchModal {
  ...
  updateSearch() {
    ...
    result.map((k) => {
      ...
      matches[key].score = matches[key].score
        ? matches[key].score > k.score
          ? matches[key].score
          : k.score
        : k.score;
    });
