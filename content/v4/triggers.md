...
[extra]
url = "https://github.com/spinframework/spin-docs/blob/main/content/v4/triggers.md"
...
source = "target/wasm32-wasip2/release/checkout.wasm"
...
[component.rust-http-trigger-example]
source = "rust-http-trigger-example/target/wasm32-wasip2/release/rust_http_trigger_example.wasm"
...
[component.rust-redis-trigger-example]
source = "rust-redis-trigger-example/target/wasm32-wasip2/release/rust_redis_trigger_example.wasm"
allowed_outbound_hosts = []
