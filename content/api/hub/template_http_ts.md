title = "TypeScript HTTP trigger template"
...
This is the default HTTP trigger template for TypeScript. It installs by default with the [Spin install script](/install#installing-spin).
