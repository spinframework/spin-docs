...
- Fetch the OpenAPI Key from the Spin Config [Reference](/dynamic-configuration#application-variables-runtime-configuration)
...
- [Sending Outbound HTTP Requests](/javascript-components#sending-outbound-http-requests)

- [Spin Config](/dynamic-configuration#application-variables-runtime-configuration)
